...
if ($horarios[$dia][$hora] === "ocupado") {
    $mensagem = "Este horário já foi reservado, por favor selecione outro.";
} else {
    // Marca como ocupado e salva
    $horarios[$dia][$hora] = "ocupado";
    file_put_contents($arquivo, json_encode($horarios, JSON_PRETTY_PRINT));
    $mensagem = "Reserva confirmada! </br></br>Para confirmar entre em contato conosco :</br></br> (83) 94002-8922";
}
?>
...
<head>
    ...
    <style>
        ...
        .box {
            ...
            box-shadow: 0 0 25px rgba(255, 187, 0, 0.25);
        }
